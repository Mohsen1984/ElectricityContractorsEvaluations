var basePath = '/app/ExternalOrganization';
...
app.config(['$translateProvider', '$stateProvider', "$locationProvider", "$urlRouterProvider", "cultureProvider",
    function ($translateProvider, $stateProvider, $locationProvider, $urlRouterProvider, cultureProvider) {
        ...
        $stateProvider
            ...
            .state('ExternalOrganization.List', {
                url: '',
            ...
            .state('ExternalOrganization.Create', {
                url: '/Create',
                templateUrl: function (params) {
            ...
            .state('ExternalOrganization.Details', {
                url: '/Details/:id',
                templateUrl: function (params) {
            ...
            .state('ExternalOrganization.Edit', {
                url: '/Edit/:id',
                templateUrl: function (params) {
            ...
            .state('ExternalOrganization.Delete', {
                url: '/Delete/:id',
                templateUrl: function (params) {
...
app.controller("RootController",
    ["$scope", "$state", "esDatasource", "$http", "$sce", "$uibModal",
        function ($scope, $state, esDatasource, $http, $sce, $uibModal) {
            var vm = this;
            vm.success = function () {
                $state.go("ExternalOrganization.List");
            };
            vm.error = function () {
            };

            vm.ds = new esDatasource({
                url: '/ExternalOrganization/GetAllPaged',
                method:'GET',
                params: {
                    pageIndex: 0,
                    pageSize: 5
            ...
            vm.doAdvancedSearch = function () {
                vm.searchMode = 'advanced';
                vm.ds.setUrl('/ExternalOrganization/GetAllPaged');
                vm.ds.refresh();
            };
...
app.controller("DetailsController",
    ["$stateParams", "esDatasource",
        function ($stateParams, esDatasource) {
            var vm = this;
            vm.ds = new esDatasource({
                url: '/ExternalOrganization/GetById/' + $stateParams.id,
                method:'GET'
            });
            vm.ds.refresh();
        }]);
